...
BACK = pygame.image.load(os.path.join(IMG_DIR, "back.png"))

EXP = pygame.mixer.Sound(os.path.join(IMG_DIR, "explodir.ogg"))
AUDIO = pygame.mixer.music.load(os.path.join(IMG_DIR, "audio.ogg"))
...
CLOUD = pygame.image.load(os.path.join(IMG_DIR, 'Other/Cloud2.png'))
